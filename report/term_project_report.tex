...
\begin{proof}
	...
	\begin{itemize}		
		...
		By the induction hypothesis and permutation lemma, we have $\Gamma,y:T_2\vdash [x\mapsto s]t_1:T_1$. Then by the \text{T-Der} rule, we immediately have our desired result $\Gamma,y:[T_2]_\public\vdash [x\mapsto s]t_1:T_1$.
