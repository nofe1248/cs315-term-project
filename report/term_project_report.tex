...
\begin{proof}
	...
	\begin{itemize}
		\item \emph{Case} \textsc{T-Var}:
		
		\item \emph{Case} \textsc{T-Abs}:
		
		\item \emph{Case} \textsc{T-App}:
		
		\item \emph{Case} \textsc{T-Pro}:
		
		\item \emph{Case} \textsc{T-Let}:
		
		\item \emph{Case} \textsc{T-Approx}:
		
		\item \emph{Case} \textsc{T-Record}:
		
		\item \emph{Case} \textsc{T-Proj}:
		
		\item \emph{Case} \textsc{T-True}:
		
		\item \emph{Case} \textsc{T-False}:
		
		\item \emph{Case} \textsc{T-Cond}:
		
		\item \emph{Case} \textsc{T-Zero}:
		
		\item \emph{Case} \textsc{T-Succ}:
		
		\item \emph{Case} \textsc{T-Pred}:
		
		\item \emph{Case} \textsc{T-IsZero}:
		
		\item \emph{Case} \textsc{T-Unit}:
		
		\item \emph{Case} \textsc{T-Unit-Elim}:
	\end{itemize}
\end{proof}
