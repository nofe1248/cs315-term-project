...
Intuitively, a term of type $\gradedt{\ell}{T}$ is a value that should be used according to some security policies, the grade $\ell$ attached to the modality acts as a \emph{capability} or a requirement: it specifies the minimum security level of the context necessary to "unbox" and use the value.
...
$$
y:[T]_\ell\vdash y:T\quad\text{and}\quad \ell\cdot\public=\secret
$$

which is clearly impossible with $\secret\sqsubseteq\public$.
