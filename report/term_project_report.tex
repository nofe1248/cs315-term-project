...
Property (1) is immediate, but there is no rule that allows the derivation of (2). The \textsc{T-Var} rule is inapplicable in this context because it requires that the used variable must have a $\public$ grade. So the term is ill-typed.
...
Here we following a similar approach to Hodas \cite{hodas1994logic} and Polakow \cite{polakow2015embedding}. We split the context into two parts:
